...
var shotX = 0;
var shotY = 0;
shotX = x + lengthdir_x(0, lookDir); //bullets can go through walls if standing near one
shotY = y + lengthdir_y(0, lookDir); //bullets can go through walls if standing near one
attacking = 1;
if silenced = false
{
	global.gunshotHeard = 1;
}
if shotgun = true
    {
