...
switch(weapon)
	...
	case "AK47":
		...
		barrelLength = 20; //y position?
		flashValue = 12; shellToggle = true; shellSource = 7;
	...
	case "Shotgun":
		...
		barrelLength = 20;
		flashValue = 12; shellToggle = true; shellSource = 9;
	...
	case "DoubleBarrel":
		...
		barrelLength = 20;
		flashValue = 12; shellToggle = false; shellSource = 0;
	...
	case "MP5":
		...
		barrelLength = 31;
		flashValue = 12; shellToggle = true; shellSource = 20;
	...
	case "Silencer":
		...
		barrelLength = 32;
		flashValue = 6; shellToggle = true; shellSource = 17;
