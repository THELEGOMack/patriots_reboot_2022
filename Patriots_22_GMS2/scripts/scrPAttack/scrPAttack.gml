function scrPAttack(){
	...
	if (weapon = "Shotgun") or (weapon = "DoubleBarrel") or (weapon = "Spas12") or (weapon = "Baikal")
	{
        ...
        {
        var shot = instance_create_depth(x, y, depth, objPBullet);
	...
	call_later(shellWait, time_source_units_frames, _shellSpawn, false); //or create time source that destroys itself on restart to avoid crashes?
	}
	}
