if speed > 0.5
    {
    draw_sprite_ext(enemyLegs, legIndex, x+1, y+1, image_xscale, image_yscale, legAngle, c_black, 0.5);
    draw_sprite_ext(enemyLegs, legIndex, x, y, image_xscale, image_yscale, legAngle, c_white, image_alpha);
    }
...
var text_1 = "Ammo: " + string(ammoEnemy);
var text_2 = "Weapon: " + string(weapon);
var text_3 = "State: " + string(state);
